...
###############################
:date: 2017-01-16 18:13
:author: arvimal
:category: Data Structures and Algorithms, Programming, Python
:slug: binary-search-algorithm-study
:status: published

Introduction
------------

**B**\ inary Search is a search method used to find an object in a data set. This is much faster compared to the Linear Search algorithm we saw in a \ `previous post <https://arvimal.wordpress.com/2017/01/15/linear-search-algorithm-study/>`__.
...
#. Find the lowest (index ``0``), highest (index ``n``), and the middle index of the dataset.
...
[caption id="attachment_2310" align="alignnone" width="1280"]\ |binary_search_depiction-svg| Binary Search - Source: Wikipedia[/caption]
...
#. It finds the element of interest in logarithmic time, hence is also known as, \ ``Logarithmic Search``.
...
.. |binary_search_depiction-svg| image:: https://arvimal.files.wordpress.com/2017/01/binary_search_depiction-svg.png
   :class: alignnone size-full wp-image-2310
   :width: 1280px
   :height: 545px
